...
class bdPaygateOnePAY_ControllerPublic_OnePAY extends XenForo_ControllerPublic_Abstract
{
    public function actionIndex()
    {
        ...
        /** @var bdPaygateOnePAY_Processor_Local $local */
        $local = bdPaygate_Processor_Abstract::create('bdPaygateOnePAY_Processor_Local');
        /** @var bdPaygateOnePAY_Processor_International $international */
        $international = bdPaygate_Processor_Abstract::create('bdPaygateOnePAY_Processor_International');

        switch ($input['pay']) {
            case 'local':
                $link = $local->bdPaygateOnePAY_getLink(
                    $input['amount'],
                    $input['currency'],
                    $input['itemName'],
                    bdPaygateOnePAY_Helper_ItemId::createUniqueItemId($input['itemId']),
                ...
                break;
            case 'international':
                $link = $international->bdPaygateOnePAY_getLink(
                    $input['amount'],
                    $input['currency'],
                    $input['itemName'],
                    bdPaygateOnePAY_Helper_ItemId::createUniqueItemId($input['itemId']),
        ...
        return $this->responseView('bdPaygateOnePAY_ViewPublic_OnePAY_Index', 'bdpaygateonepay_onepay_index',
            $viewParams);
    }
    ...
    public function actionComplete()
    {
        ...
        return $this->responseView('bdPaygateOnePAY_ViewPublic_OnePAY_Complete', 'bdpaygateonepay_onepay_complete',
            $viewParams);
    }
